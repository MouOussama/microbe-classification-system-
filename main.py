...
# Fix 1: GPU Environment Variables
os.environ['CUDA_VISIBLE_DEVICES'] = '0'
print(f"✅ CUDA_VISIBLE_DEVICES set to 0 (BASE_DIR: {BASE_DIR})")
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Add Test Model tab dynamically
        test_tab = QtWidgets.QWidget()
        test_layout = QtWidgets.QVBoxLayout(test_tab)
        self.btn_test_model = QtWidgets.QPushButton('Run model_testing.py')
        test_layout.addWidget(self.btn_test_model)
        self.tabWidget.addTab(test_tab, '6. Test Model')
        self.btn_test_model.clicked.connect(lambda: self.run_script('model_testing.py', '6. Test Model & Predictions'))
        
        self.is_running = False
        self.statusbar.showMessage('✅ Ready! Tabs 1→6 for workflow.')
    ...
    def connect_buttons(self):
        ...
        # Test button connected dynamically
    ...
    def disable_buttons(self):
        for btn_name in ['btn_generate_data', 'btn_train_verbose', 'btn_demo_features', 'btn_analysis', 'btn_plots', 'btn_test_model']:
